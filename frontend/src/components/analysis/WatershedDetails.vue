  ...
  <div>
    <div v-if="watershedDetails">
      ...
      <div class="my-3">
        ...
        (note: glacier search area is {{ (watershedDetails.projected_geometry_area_simplified / watershedDetails.projected_geometry_area * 100).toFixed(1) }}% of the watershed area)
      </div>
      <div v-if="precipData">
