let layers = [
  ...
  },
  {
    ...
    'type': 'fill',
    'source': 'composite',
    'source-layer': 'ground_water_aquifers',
    'layout': { 'visibility': 'none' },
    'paint': {
  ...
  },
  {
    ...
    'source-layer': 'freshwater_atlas_stream_directions',
    'layout': { 'visibility': 'none' },
    'paint': { 'fill-color': 'hsla(181, 100%, 62%, 0.15)' }
  },
  {
    'id': 'critical_habitat_species_at_risk',
    'type': 'fill',
    'source': 'composite',
    'source-layer': 'critical_habitat_species_at_r-cy8usw',
    'layout': { 'visibility': 'none' },
    'paint': {
      'fill-color': [
        'interpolate',
  ...
  },
  {
    ...
    'layout': { 'visibility': 'none' },
    'paint': {
      'circle-stroke-color': 'hsl(219, 0%, 100%)',
      'circle-stroke-width': 1,
      'circle-color': 'hsl(269, 100%, 53%)'
    }
  },
  {
  ...
  },
  {
    ...
    'type': 'circle',
    'source': 'composite',
    'source-layer': 'groundwater_wells_subset-8rbrc9',
    'layout': { 'visibility': 'none' },
    'paint': {
      'circle-color': [
        'interpolate',
        ...
        ['zoom'],
        7,
        'hsla(245, 100%, 54%, 0.01)',
        12,
        'hsla(245, 100%, 54%, 0.44)',
        15,
        'hsla(245, 100%, 54%, 0.8)'
      ],
      'circle-stroke-width': 1,
  ...
  },
  {
    ...
    'type': 'circle',
    'source': 'composite',
    'source-layer': 'water_rights_applications-9zhw62',
    'layout': { 'visibility': 'none' },
    'paint': {
      'circle-color': 'hsl(0, 100%, 53%)',
      'circle-stroke-color': 'hsl(0, 0%, 100%)',
      'circle-stroke-width': 1,
      'circle-opacity': [
        'interpolate',
  ...
  },
  {
    ...
    'layout': { 'visibility': 'none' },
    'paint': {
      'circle-color': 'hsl(277, 38%, 33%)',
      'circle-radius': [
        'interpolate',
        ['linear'],
        ['get', 'FIRST_NATION_FEDERAL_ID'],
        549,
        5,
        646,
        10
  ...
  },
  {
    ...
    'layout': { 'visibility': 'none' },
    'paint': {
      'fill-color': 'hsla(163, 60%, 59%, 0.1)',
      'fill-outline-color': 'hsla(167, 75%, 26%, 0.69)'
    }
  },
  {
    'id': 'fn_treaty_lands',
    ...
    'layout': { 'visibility': 'none' },
    'paint': {
      'fill-color': 'hsla(190, 73%, 57%, 0.15)',
      'fill-outline-color': 'hsl(193, 77%, 30%)'
    }
  },
  {
    ...
    'type': 'fill',
    'source': 'composite',
    'source-layer': 'glaciers_subset',
    'layout': { 'visibility': 'none' },
    'paint': {
      'fill-color': 'hsl(191, 100%, 53%)',
      'fill-outline-color': 'hsl(222, 100%, 48%)'
    }
  },
  {
  ...
  },
  {
    ...
    'type': 'symbol',
    'source': 'composite',
    'source-layer': 'fish_observations_subset',
  ...
  },
  {
    ...
    'type': 'circle',
    'source': 'composite',
    'source-layer': 'water_approval_points_subset',
    'layout': { 'visibility': 'none' },
    'paint': {
      'circle-color': [
        'match',
      ...
      'circle-stroke-width': 1,
      'circle-stroke-color': 'hsl(0, 0%, 43%)',
      'circle-radius': [
        'interpolate',
        ['linear'],
        ['zoom'],
