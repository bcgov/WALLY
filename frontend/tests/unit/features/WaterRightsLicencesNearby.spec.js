...
describe('WaterRightsLicencesNearby.vue', () => {
  ...
  it('filters based on POD type', () => {
    ...
    expect(wrapper.vm.filteredLicences.length).toBe(5)
  ...
  it('counts approvals', () => {
    ...
    expect(wrapper.vm.approvalCount).toBe(1)
  })
})
