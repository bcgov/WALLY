...
import WaterRightsLicencesByDistance from '@/components/analysis/WaterRightsLicencesByDistance.vue'
...
describe('WaterRightsLicencesByDistance.vue', () => {
  ...
  it('filters based on POD type', () => {
    const wrapper = shallowMount(WaterRightsLicencesByDistance, {
      vuetify,
      store,
      localVue
    })
