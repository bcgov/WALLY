#!/bin/bash
# USAGE: ./load_fwa.sh <layer_name>
# Load Freshwater Atlas data.
# Freshwater Atlas streams and watersheds come in large files (GeoDatabase .GDB files) and must
# be loaded with this script instead of load_layer_data.
#
