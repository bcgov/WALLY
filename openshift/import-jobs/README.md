...
| iit-water.0tsq064k                   | aquifers, bc_major_watersheds, critical_habitat_species_at_risk, freshwater_atlas_glaciers | `oc process -f mapbox-upload.job.yaml -p JOB_NAME=0tsq064k -p LAYER_NAME=iit-water.0tsq064k | oc apply -f -`
