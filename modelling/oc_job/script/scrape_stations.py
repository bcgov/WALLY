...
with open(local_file_path, "a") as outfile:
    ...
    for row in stations_df.iterrows():
        ...
        with open(local_licence_file_path, "a") as licence_outfile:
            ...
            licence_url = station_url + '/licences?generated_watershed_id=' + str(watershed_info["gen_id"])
            for i in range(0,3):
                try:
        ...
        with open(local_approvals_file_path, "a") as approvals_outfile:
            ...
            approvals_url = station_url + '/approvals?generated_watershed_id=' + str(watershed_info["gen_id"])
            for i in range(0,3):
                try:
