...
df = pd.read_csv("../data/2_scrape_results/sept13_licence_data/watershed_stats_output.csv")

lowflows_df = pd.read_csv("../data/2_scrape_results/sept13_licence_data/lowflows_all_stations.csv")
...
df_approvals = pd.read_csv("../data/2_scrape_results/sept13_licence_data/watershed_approvals_output.csv")
...
df_licences = pd.read_csv("../data/2_scrape_results/sept13_licence_data/watershed_licence_output.csv")
...
df_allocation_coef = pd.read_csv("../data/2_scrape_results/sept13_licence_data/monthly_allocation_coefficients.csv")
# Purpose_Num, Consumptive?, Purpose, Units, Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec, Sum, Reference
df_return_coef = pd.read_csv("../data/2_scrape_results/sept13_licence_data/monthly_return_coefficients.csv")
    ...
    for index, station in df.iterrows():
        ...
        for index, licence_record in licence_records.iterrows():
            ...
            for licence in licences:
                ...
                if allocation_coef.empty: # means we don't have a purpose type allocation value
                    continue
