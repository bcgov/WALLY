...
with open('../../output/db/stations_gt2000_fullmonth.json') as json_file:
    ...
    if len(stations_output) > 0:
        ...
        with open("../../output/stations/" + info_filename, "w") as outfile:
            json.dump(stations_output, outfile)
        
        # write stations geometry in a different file to save working memory space
        with open("../../output/stations/" + geometry_filename, "w") as outfile:
