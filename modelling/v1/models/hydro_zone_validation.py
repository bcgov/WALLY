...
model = XGBRegressor(**xgb_params, random_state=42, objective="reg:squarederror")
...
for filename in sorted(os.listdir(directory)):
    if filename.endswith(".csv"):
        ...
        for train_index, test_index in kf.split(X):
            ...
            model.fit(X_train, y_train, eval_set=eval_set, eval_metric=["rmse"], early_stopping_rounds=50)
