...
# TODO
# Fix average_slope calculation
# re-run solar exposure calculation to check correct value
# fix k-fold indicies issue on overlapping index
# 
...
for filename in sorted(os.listdir(directory)):
    if filename.endswith(".csv"):
        ...
        output_dir = "./output/20_year_stations_analysis/xgboost/zone_" + zone_name + "/"
