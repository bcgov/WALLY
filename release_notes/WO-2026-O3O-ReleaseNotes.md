...
To get around this, I authenticated to the openshift cluster' container registry and pulled the latest whitebox tools image from a previous build. I then created a PAT token with SSO access to the BCGov Organization, and gave it package read/write access. I then tagged and push this package to the BCGov organization. I made this package publically available, such that there will be no issues when running locally or building our development/testing/production images.
...
docker tag image-registry.apps.silver.devops.gov.bc.ca/d1b5d2-tools/whiteboxtools:latest ghcr.io/bcgov/wally/whiteboxtools-builder:legacy-2023
docker push ghcr.io/bcgov/wally/whiteboxtools-builder:legacy-2023
```
...
Please see Dockerfile & Dockerfile.dev.2026 for reference.
