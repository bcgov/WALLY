...
def upgrade():
    ...
    op.create_table('mapbox_source',
                    sa.Column('create_user', sa.String(length=100), nullable=True, comment='The user who created this record in the database.'),
                    ...
                    sa.Column('update_user', sa.String(length=100), nullable=True, comment='The user who last updated this record in the database.'),
