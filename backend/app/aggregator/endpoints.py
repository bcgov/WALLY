...
from app.layers.first_nations import CommunityLocation, TreatyLand, TreatyArea
...
API_DATASOURCES = {
    ...
    "fn_treaty_areas": TreatyArea,
    "fn_community_locations": CommunityLocation,
    "fn_treaty_lands": TreatyLand
