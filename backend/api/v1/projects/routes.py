...
def get_projects(
    ...
    return controller.get_projects_with_documents(db, x_auth_subject)
...
def create_project(
    ...
    return controller.create_project(db, x_auth_subject, project.name, project.description)
...
def delete_project(
    ...
    return controller.delete_project(db, x_auth_subject, project_uuid)
...
def upload_document_to_project(
    ...
    """
    return controller.create_and_upload_document(db, x_auth_subject, project_uuid, files)
...
def delete_project_document(
    ...
    return controller.delete_project_document(db, x_auth_subject, project_document_uuid)
...
def get_project_documents(
    ...
    return controller.get_documents(db, x_auth_subject, project_uuid)
...
def download_project_document(
    ...
    return controller.download_project_document(db, x_auth_subject, project_document_uuid)
...
def download_project(
    ...
    return controller.download_project(db, x_auth_subject, project_uuid)
